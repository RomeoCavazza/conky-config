...
![Empty workspace](https://raw.githubusercontent.com/wiki/RomeoCavazza/nixos-config/images/conky-config/assets/empty.webp)

### Active Workspace

The same rails with an editor window open in the center.

![Active workspace](https://raw.githubusercontent.com/wiki/RomeoCavazza/nixos-config/images/conky-config/assets/full.webp)
